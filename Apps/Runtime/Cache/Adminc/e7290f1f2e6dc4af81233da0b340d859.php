...
<div class="right-content">
    ...
    <a href="add.html" class="button bg-sub"><i class="icon-plus"></i> 添加用户组</a>
</div>

<div class="panel">
    <div class="panel-head">用户组管理</div>
	<div class="panel-body">
        <table class="table table-hover my-table">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><a href="<?php echo U('rules',array('id'=>$v['id']));?>" class="icon-magic margin-right">授权</a> <a href="<?php echo U('edit',array('id'=>$v['id']));?>" class="icon-pencil margin-right">编辑</a> <a href="javascript:;" data-id="<?php echo ($v["id"]); ?>" class="icon-times mydel">删除</a></td>
